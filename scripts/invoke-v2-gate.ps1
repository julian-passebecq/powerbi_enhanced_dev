...
try {
    ...
    foreach ($framework in @('net10.0', 'net48')) {
        Invoke-Test 'tests/PbiBench.V11.Tests/PbiBench.V11.Tests.csproj' $framework 'FullyQualifiedName~FeatureCatalogTests|FullyQualifiedName~ModuleCatalogTests|FullyQualifiedName~PlatformTests|FullyQualifiedName~LanguageTests'
    }
    ...
    Invoke-Test 'tests/PbiBench.Semantic.Tests/PbiBench.Semantic.Tests.csproj' 'net48' 'FullyQualifiedName~DiagramAuthoringTests|FullyQualifiedName~ScriptPreviewTests|FullyQualifiedName~SemanticAndAutomationTests|FullyQualifiedName~SelectionInspectorTests'
